...
namespace Dumball_BrickVersion
{
    public class Game1 : Game
    {
        ...
        private SpriteBatch _spriteBatchBG1;
        private SpriteBatch _spriteBatchBG2;
        ...
        {
            _spriteBatchBG1 = new SpriteBatch(GraphicsDevice);
            _spriteBatchBG2 = new SpriteBatch(GraphicsDevice);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatchBG1.Begin(SpriteSortMode.Deferred, null, null, null, null, null, shakeTransform);
            _spriteBatchBG1.Draw(background, new Rectangle(0, 0, _graphics.PreferredBackBufferWidth, _graphics.PreferredBackBufferHeight), Color.White);
            _spriteBatchBG1.End();

            _spriteBatchBG2.Begin(transformMatrix: Matrix.CreateTranslation(0, 290, 0));
            _tilemap.Draw(gameTime, _spriteBatchBG2);
            _spriteBatchBG2.End();
